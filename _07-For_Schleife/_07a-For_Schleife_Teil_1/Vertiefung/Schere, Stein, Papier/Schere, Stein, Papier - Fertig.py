...
def wahlanalyse_punkte_mensch(wahl_computer, zahl_wahl_mensch):
    if zahl_wahl_mensch == 0 and wahl_computer == 2:
        punkte_mensch = 1
        # Sieg Mensch
    elif zahl_wahl_mensch == 1 and wahl_computer == 0:
        ...
        punkte_mensch = 0
        # Unentschieden oder Mensch hat verloren
    return int(punkte_mensch)


def wahlanalyse_punkte_computer(wahl_computer, zahl_wahl_mensch):
    if zahl_wahl_mensch == 0 and wahl_computer == 1:
        punkte_computer = 1
        # Sieg PC
    elif zahl_wahl_mensch == 1 and wahl_computer == 2:
        punkte_computer = 1
        ...
        punkte_computer = 0
        # Unentschieden oder Computer hat verloren
    return int(punkte_computer)
...
for runden in range(0, 3):
    ...
    punkte_mensch_analyse = wahlanalyse_punkte_mensch(wahl_computer, zahl_wahl_mensch)
    punkte_mensch += punkte_mensch_analyse
    punkte_computer_analyse = wahlanalyse_punkte_computer(wahl_computer, zahl_wahl_mensch)
