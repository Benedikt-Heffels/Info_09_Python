...
print("Die Zahlen müssen zwischen 1 und 49 liegen! Zudem dürfen sich die ausgesuchten Zahlen nicht wiederholen.")
...
print("Benedikt Heffels, Luca Voerster und Fathi Kacar")
