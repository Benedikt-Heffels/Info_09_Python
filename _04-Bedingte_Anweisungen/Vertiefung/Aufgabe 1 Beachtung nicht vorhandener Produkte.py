...
if wahl in waren:
    ...
    if menge[Nummer_waren] == 0:
        print("Davon ist leider nichts vorhanden!")
        print("Wollen sie denn", wahl, "vorbestellen?")
        Vorbestellung = input("Diese wären dann Morgen zur Abholung bereit! ")
        if Vorbestellung in JA:
            Gewuenschte_Anzahl = input("Gerne! Wie viel " + str(wahl) + " möchten sie denn vorbestellen? ")
            print("Ok, dann sind Morgen", Gewuenschte_Anzahl, wahl, "für sie zur Abholung bereit.")
        elif Vorbestellung in NEIN:
            print("Das tut mir Leid. Dann können wir leider nichts für sie tun.")
    elif menge[Nummer_waren] >= 1:
